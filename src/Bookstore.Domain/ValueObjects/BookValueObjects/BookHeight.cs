...
public record BookHeight
{
	public double Value { get; }

	public BookHeight(double value)
	{
	...
	public static implicit operator double(BookHeight value)
		=> value.Value;

	public static implicit operator BookHeight(double value)
		=> new(value);
}
